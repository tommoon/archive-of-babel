            ...
            <form className="form-control w-full space-y-2">
              ...
              <div className="grid grid-cols-2 gap-4">
                <label className="input input-bordered input-sm flex items-center gap-2">
                  ...
                  <input
                    type="number"
                    className="input input-xs w-full max-w-s px-0"
                    placeholder="1"
                    min={1}
                    max={4}
                  />
      ...
      <div className="card h-full bg-base-100 w-80 shadow-xl">
        <div className="card-body">
          <h2 className="card-title">Learn</h2>
                  <p>The Archive does not actually contain every possible book in existence, 
                      It actually uses an algorithm to generate each book according to its location.
                      A number of technical tricks are used to allow the Archive to run smoothly in a 
                      modern web browser.
          </p>
          <div className="card-actions">
            <button className="btn btn-accent btn-sm">Read More...</button>
