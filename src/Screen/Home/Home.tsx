...
export const Home = () => {
  ...
  useEffect(() => {
    ...
    // Runs once on mount: returning home clears any in-progress game location.
    // The setters are stable zustand actions.
  ...
  return (
    <HelmetProvider>
      <Helmet>
      <title>Archive of Babel - the playable recreation of the short story 'The Library of Babel' by Jorge Luis Borges</title>
      <meta name="description" content="A browser based 3D game that can be played for free on mobile and desktop. Wonder the endless Library reading the books, searching for esoteric knowledge." />
        ...
        <meta property="og:description" content='An infinite library to explore in browser, on mobile or desktop. Based on the short story "The Library of Babel" by Jorge Luis Borges.' />
