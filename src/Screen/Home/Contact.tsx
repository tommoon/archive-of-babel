...
export default function Contact() {
  ...
  return (
    <div
      className=" m-auto max-w-prose text-base h-screen flex flex-col gap-y-8 justify-center my-32"
      style={{
        fontSize: "unset",
      }}
    >
      ...
      <Container>
        <div className="flex gap-x-2">
          <p className="text-xl">
            Please consider supporting server costs by buying me a coffee!
          </p>
          <BuyMeACoffee />
        </div>
      </Container>
